...
public class StudySecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_study_second, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_8_1);
        ...
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_8_1));
        alpaAdd(view.findViewById(R.id.fm_tv_8_2));
        alpaAdd(view.findViewById(R.id.fm_tv_8_3));
