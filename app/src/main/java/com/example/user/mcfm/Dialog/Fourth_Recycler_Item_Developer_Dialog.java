...
public class Fourth_Recycler_Item_Developer_Dialog extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fourth_recycler_item_developer_dialog);
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fourth_Recycler_Item_Developer_Dialog.this.finish();
            }
        });
    }
}
