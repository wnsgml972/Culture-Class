 ...
 */
public class ExplainationFirstFragment extends Fragment {
    ...
    public ExplainationFirstFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_explaination_first, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_5_1);
        button1.setEnabled(true);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new ExplainationSecondFragment());
                button1.setEnabled(false);
            }
        });
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_5_1));
        alpaAdd(view.findViewById(R.id.fm_tv_5_2));
        alpaAdd(view.findViewById(R.id.fm_tv_5_3));
