 ...
 */
public class IntroduceFirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_introduce_first, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_3_1);
        button2 = (Button)view.findViewById(R.id.fm_bt_3_2);
        button1.setEnabled(true);
        button2.setEnabled(true);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new ExplainationFirstFragment());
        ...
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_3_1));
        alpaAdd(view.findViewById(R.id.fm_tv_3_2));
