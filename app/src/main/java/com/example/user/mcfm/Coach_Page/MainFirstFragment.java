...
public class MainFirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button1 = (Button)view.findViewById(R.id.fm_bt_1_1);
        button2 = (Button)view.findViewById(R.id.fm_bt_1_2);
        button1.setEnabled(true);
        button2.setEnabled(true);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new IntroduceFirstFragment());
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new MainSecondFragment());
                button2.setEnabled(false);
            }
        });
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_1_1));
        alpaAdd(view.findViewById(R.id.fm_tv_1_2));
        alpaAdd(view.findViewById(R.id.fm_tv_1_3));
