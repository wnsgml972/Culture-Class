 ...
 */
public class MarriedFirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_married_first, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_9_1);
        button1.setEnabled(true);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new MarriedSecondFragment());
                button1.setEnabled(false);
            }
        });
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_9_1));
        alpaAdd(view.findViewById(R.id.fm_tv_9_2));
        alpaAdd(view.findViewById(R.id.fm_tv_9_3));
