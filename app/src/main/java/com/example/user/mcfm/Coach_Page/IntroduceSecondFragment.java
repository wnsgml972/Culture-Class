 ...
 */
public class IntroduceSecondFragment extends Fragment {
    ...
    public IntroduceSecondFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_introduce_second, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_4_1);
        button2 = (Button)view.findViewById(R.id.fm_bt_4_2);
        button3 = (Button)view.findViewById(R.id.fm_bt_4_3);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setFragment(new StudyFirstFragment());
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new MarriedFirstFragment());
        ...
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_4_1));
        alpaAdd(view.findViewById(R.id.fm_tv_4_2));
        alpaAdd(view.findViewById(R.id.fm_tv_4_3));
        alpaButtonAdd(button1);
        alpaButtonAdd(button2);
        alpaButtonAdd(button3);
        startAnimation(flag);
        return view;
    }
