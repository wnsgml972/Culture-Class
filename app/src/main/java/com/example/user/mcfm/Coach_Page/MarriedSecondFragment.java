 ...
 */
public class MarriedSecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_married_second, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_10_1);
        ...
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_10_1));
        alpaAdd(view.findViewById(R.id.fm_tv_10_2));
        alpaAdd(view.findViewById(R.id.fm_tv_10_3));
