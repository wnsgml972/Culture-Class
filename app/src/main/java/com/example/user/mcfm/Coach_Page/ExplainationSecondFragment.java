 ...
 */
public class ExplainationSecondFragment extends Fragment {
    ...
    public ExplainationSecondFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        flag = 0;
        View view =inflater.inflate(R.layout.fragment_explaination_second, container, false);
        button1 = (Button)view.findViewById(R.id.fm_bt_6_1);
        button1.setEnabled(true);
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setFragment(new IntroduceSecondFragment());
                button1.setEnabled(false);
            }
        });
        initAnimation();
        alpaAdd(view.findViewById(R.id.fm_tv_6_1));
        alpaAdd(view.findViewById(R.id.fm_tv_6_2));
        alpaAdd(view.findViewById(R.id.fm_tv_6_3));
